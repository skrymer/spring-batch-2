...
insert into acquisition values ('MSFT', 50, 'sonni');
insert into acquisition values ('AAPL', 2, 'sonni');
insert into acquisition values ('MAERSK-A.CO', 250, 'sonni');
insert into acquisition values ('MAERSK-B.CO', 84, 'sonni');
insert into acquisition values ('SSUN.DE', 65, 'sonni');
